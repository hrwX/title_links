...
override_whitelisted_methods = {
	"frappe.desk.search.search_link": "title_links.desk.search.search_link",
	"frappe.desk.reportview.get": "title_links.desk.reportview.get",
	"frappe.desk.form.load.getdoc": "title_links.desk.form.load.getdoc",
	"frappe.desk.search.get_link_title": "title_links.desk.search.get_link_title"
}
